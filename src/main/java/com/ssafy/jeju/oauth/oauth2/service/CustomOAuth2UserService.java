package com.ssafy.jeju.oauth.oauth2.service;

import com.ssafy.jeju.oauth.CustomOAuth2User;
import com.ssafy.jeju.oauth.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User getUser(OAuthAttributes attributes, SocialType socialType) {
        User findUser = userMapper.findBySocialTypeAndSocialId(socialType,
    ...
    private User saveUser(OAuthAttributes attributes, SocialType socialType) {
        ...
        return userMapper.findByEmail(createdUser.getEmail()).orElseThrow(() -> new RuntimeException("사용자를 찾을 수 없습니다."));
    }
}
